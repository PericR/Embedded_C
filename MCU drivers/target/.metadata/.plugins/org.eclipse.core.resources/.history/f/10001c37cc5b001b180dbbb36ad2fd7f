 ...
 */
typedef struct{
	uint8_t USART_Mode;										/*Posible values from @USART_Mode*/
	uint32_t USART_Baud;									/*Posible values from @USART_Baud*/
	uint8_t USART_NoOfStopBits;								/*Posible values from @USART_NoOfStopBits*/
	uint8_t USART_WordLength;								/*Posible values from @USART_ParityControl*/
	uint8_t USART_ParityControl;							/*Posible values from @USART_ParityControl*/
	uint8_t USART_HWFlowControl;							/*Posible values from @USART_HWFlowControl*/
}USART_Config_t;
