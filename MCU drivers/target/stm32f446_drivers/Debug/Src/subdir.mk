...
Src/013i2c_slave_tx_string.o: ../Src/013i2c_slave_tx_string.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"/home/robert/Projects/Embedded-C/MCU drivers/target/stm32f446_drivers/drivers/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/013i2c_slave_tx_string.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
