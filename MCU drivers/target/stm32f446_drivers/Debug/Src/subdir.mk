...
C_SRCS += \
../Src/003_external_led_btn.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/003_external_led_btn.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/003_external_led_btn.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/003_external_led_btn.o: ../Src/003_external_led_btn.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"/home/robert/Projects/Embedded-C/MCU drivers/target/stm32f446_drivers/drivers/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/003_external_led_btn.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
