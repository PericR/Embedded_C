...
C_SRCS += \
../Src/001_led_toggle_external.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/001_led_toggle_external.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/001_led_toggle_external.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/001_led_toggle_external.o: ../Src/001_led_toggle_external.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"/home/robert/Projects/Embedded-C/MCU drivers/target/stm32f446_drivers/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/001_led_toggle_external.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
