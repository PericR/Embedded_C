...
C_SRCS += \
../Src/007_SPI_master_slave_arduino.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/007_SPI_master_slave_arduino.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/007_SPI_master_slave_arduino.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/007_SPI_master_slave_arduino.o: ../Src/007_SPI_master_slave_arduino.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"/home/robert/Projects/Embedded-C/MCU drivers/target/stm32f446_drivers/drivers/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/007_SPI_master_slave_arduino.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
